...
rewind([{F}|Acc],         T, [{"→",{{app,{{typevar,{L,M}},{A,X}}},{B,Y}}}|R]) when F == lambda; F== pi -> rewind(Acc,T,[{{func(F),{L,M}},{{A,X},{B,Y}}}|R]);
rewind([{F}|Acc],         T, [{"→",{{L,{{app,{{typevar,M},A}},X}},{B,Y}}}|R]) when F == lambda; F== pi -> rewind(Acc,T,[{{func(F),M},{L,{{A,X},{B,Y}}}}|R]);
