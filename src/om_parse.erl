...
rewind([{open},{F}|Acc],     T,  [{"→",{{app,{{typevar,{L,M}},{A,X}}},{B,Y}}}|R]) when ?is_fun(F) -> {T,om:flat([{{func(F),{L,M}},{{A,X},{B,Y}}}|[R|Acc]])};
rewind([{open},{F}|Acc],     T,  [{"→",{{L,{{app,{{typevar,M},A}},X}},{B,Y}}}|R]) when ?is_fun(F) -> {T,om:flat([{{func(F),M},{{L,{A,X}},{B,Y}}}|[R|Acc]])};
