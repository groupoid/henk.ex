...
\vspace{1cm}
\begin{abstract}
This paper presents the design of {\bf Om} language and implementation of its type checker and bytecode extraction to Erlang.
...
\subsection{Shifting}
Shift renames var N in B.
Renaming means adding 1 to the nat component of variable.
