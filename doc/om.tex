...
\begin{cases}
 ...
 length = \llparenthesis [ zero, \lambda (a,n) \rightarrow succ (n) ] \rrparenthesis \\
 concat = \lambda (xs,ys) \rightarrow \llparenthesis [ \lambda (x) \rightarrow ys, cons ] \rrparenthesis (xs) \\
