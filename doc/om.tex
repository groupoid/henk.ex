...
\vspace{3cm}
    ...
    \vspace{3cm}   {\Large \bf Intermediate Language with Dependent Types
                               and Strong Normalization for Erlang/OTP applications.\\}\par
...
and separate language for prover, like in {\bf HOL}, {\bf Andromeda}. The second
approach propose embedding models into single language. Such langauge should be powerful
enough for proving properties of higher inductive types. The only available prover that fits
this criteria today is {\bf cubicaltt}.
