...
unductive type in its core. Om supports predicative and impredicative hierarchies.
...
You may check if term is universe with star function.
If argument is not universe it returns $\{error,\_\}$.
...
\subsection{Shift}
Shift renames var N in N. Remaming means adding an 1 to an index of that name.
