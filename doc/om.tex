...
\endgroup
   ...
   is why Hask category is not cartesian closed but CPO\cite{cpo}. The $\bot$ type has no values.
...
\newpage
  ...
  As was shown by Wadler in Recursive Types for Free! we could deal with recusrive equations having
  ...
  define fixed point as axiom because we can't produce recursive axioms. This axioms
...
% \bibitem{pointfree}  A.Cuhna,J,Sousa Pinto, J.Proenca \textit{A Framework for Point-Free Program Transformation}
