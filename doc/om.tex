...
\tikzstyle{every initial by arrow}=[]
    ...
    \node (c) at (5,0) {\bf Induction};
    \node (d) at (5,5) {\bf Library};
    \node (e) at (2.5,2.5) {\bf PTS};
...
infinity\footnote{https://github.com/groupoid/infinity/tree/master/base}
...
Here is example of List/map natural transformation where List
is a functor and List carrier is 1-category.
