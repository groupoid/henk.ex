...
\lstset{morekeywords={record,data,inductive,extend,enum,Type,Path,unit,Unit,Nat,List,let,in,spawn,send,receive,case,sigma,pi,fst,snd,option,nat,list,sum,identifier,lambda,arrow,star,var,app,remote,sh,sub,forall,norm,type,true,false,func,id,transport,eq,dep,h}}
