...
Attempts to explore encodings are not new. The historical example is the
Church encoding for natural numbers. There are generalizations of it [Berarducci].
Nowadays there are pragmatically charged compilers using them [Gonzalez].
Insteed we introduce encoding capable of implement dependent eliminator a.k.a.
induction principle build by refining Berarducci encoding with categorical limits.
